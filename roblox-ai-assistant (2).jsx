...
export default function RobloxAIAssistant() {
    ...
    try {
      const response = await fetch("https://api.anthropic.com/v1/messages", {
        ...
        body: JSON.stringify({
          ...
          max_tokens: 1000,
          system: `You are an expert Roblox Lua programmer. Generate clean, well-commented Lua code for Roblox Studio.
          
Rules:
- Always use LocalScript or Script as appropriate
- Include comments explaining each section
- Make code modular and reusable
- Use proper Roblox API (game, script, Instance, etc.)
- Add configuration variables at the top
- Include error handling where relevant
- Format code with proper indentation

Output ONLY the Lua code block, no explanations.`,
          messages: [
